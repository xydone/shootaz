...
//        Get shader desc: shd.planeShaderDesc(sg.queryBackend());
//        Vertex Shader: vs
//        Fragment Shader: fs
//        Attributes:
...
//
pub const ATTR_plane_position = 0;
pub const ATTR_plane_color0 = 1;
...
pub fn planeShaderDesc(backend: sg.Backend) sg.ShaderDesc {
